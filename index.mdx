...
description: "An open-source Python framework for statistical, end-to-end testing of conversational AI, chatbots, virtual assistants, and other LLM-based applications."
---
